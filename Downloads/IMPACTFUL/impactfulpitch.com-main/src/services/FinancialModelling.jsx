...
const FinancialModellingImage = '/assets/services/FinancialModellingImage.webp';
        ...
        <div className='flex flex-col-reverse lg:flex-row gap-12 items-center'>
          ...
          <div className='flex flex-col lg:w-1/2'>
            ...
            <p className='text-lg text-gray-700 mb-6 leading-relaxed'>
              Our financial modelling and business valuation services provide
              you with robust, data-driven materials to present to investors. We
              create detailed projections and valuations that strengthen your
